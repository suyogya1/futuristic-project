    ...
    <main>
      ...
      <section className="section" style={{ paddingTop: 80, paddingBottom: 60 }}>
        <div className="container">
          ...
          <div style={{
            ...
            <Reveal as="div" className="panel" direction="left" distance={60} style={{
              padding: 28,
            ...
            <Reveal as="div" className="panel" direction="up" distance={50} delay={100} style={{
              padding: 28,
            ...
            <Reveal as="div" className="panel" direction="right" distance={60} delay={200} style={{
              padding: 28,
      ...
      <section className="section" style={{
        ...
        <div className="container">
          <div className="grid3" style={{ display: "grid", gap: 24, gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))" }}>
            <Reveal as="div" className="panel" direction="left" distance={70} style={{ padding: 28 }}>
            ...
            <Reveal as="div" className="panel" direction="up" distance={60} delay={80} style={{ padding: 28 }}>
              <div style={{ fontSize: 36, marginBottom: 12 }}>🔗</div>
            ...
            <Reveal as="div" className="panel" direction="right" distance={70} delay={160} style={{ padding: 28 }}>
              <div style={{ fontSize: 36, marginBottom: 12 }}>💎</div>
      ...
      <section className="section" style={{ paddingTop: 80, paddingBottom: 80 }}>
        <div className="container" style={{ display: "grid", gap: 24 }}>
          ...
          <div style={{ display: "grid", gap: 20, marginTop: 40 }}>
            <Reveal as="div" className="panel" direction="left" distance={80} style={{
              padding: 32,
            ...
            <Reveal as="div" className="panel" direction="right" distance={80} delay={80} style={{
              padding: 32,
            ...
            <Reveal as="div" className="panel" direction="left" distance={80} delay={140} style={{
              padding: 32,
      ...
      <section className="section" style={{
        ...
        <div className="container">
          ...
          >
            <Reveal as="div" className="panel" direction="left" distance={70} style={{ padding: 32 }}>
            ...
            <Reveal as="div" className="panel" direction="up" distance={60} delay={80} style={{ padding: 32 }}>
              <div style={{ fontSize: 36, marginBottom: 16 }}>💸</div>
              <div className="row between" style={{ marginBottom: 12 }}>
            ...
            <Reveal as="div" className="panel" direction="right" distance={70} delay={140} style={{ padding: 32 }}>
              <div style={{ fontSize: 36, marginBottom: 16 }}>🔒</div>
              <div className="row between" style={{ marginBottom: 12 }}>
      ...
      <section className="section" style={{ paddingTop: 80, paddingBottom: 80 }}>
        <div className="container">
          ...
          >
            <Reveal as="div" className="panel" direction="left" distance={70} style={{
              padding: 32,
            ...
            <Reveal as="div" className="panel" direction="up" distance={60} delay={80} style={{
              padding: 32,
            ...
            <Reveal as="div" className="panel" direction="right" distance={70} delay={140} style={{
              padding: 32,
              background: 'linear-gradient(135deg, rgba(108,124,255,0.08), transparent)',
              borderColor: 'rgba(108,124,255,0.2)'
            }}>
      ...
      <section className="section" style={{
        ...
        <div className="container" style={{ display: "grid", gap: 32 }}>
          ...
          <div style={{ marginTop: 32 }}>
            ...
            <Reveal as="div" className="panel" direction="right" distance={70} delay={80} style={{
              padding: 28,
              marginBottom: 20,
            ...
            <Reveal as="div" className="panel" direction="left" distance={70} delay={140} style={{
              padding: 28,
